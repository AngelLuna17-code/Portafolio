...
const Navbar = () => {
    ...
    return (
        <section>
            <nav ref={menuRef} className="top-0 py-4 text-white fixed top-0 w-screen z-30" style={{ background: 'rgba(0, 0, 0, 0.7)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
